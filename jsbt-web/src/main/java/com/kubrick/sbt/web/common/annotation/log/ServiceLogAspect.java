 ...
 * @author k
 * <p>
 * final 1、to db、es 2、format json
 */
@Slf4j
@Aspect
@Component
public class ServiceLogAspect {
	...
	@Pointcut("@annotation(com.kubrick.sbt.web.common.annotation.log.ServiceLog)")
	...
	public Object logAround(ProceedingJoinPoint joinPoint) {
		...
		try {
			...
			// String params = JSONObject.toJSONStringWithDateFormat(joinPoint.getArgs(),
			// dateFormat,
			...
			String resultJson = JSONObject.toJSONStringWithDateFormat(result, dateFormat,
					SerializerFeature.WriteMapNullValue);
