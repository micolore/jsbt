package com.kubrick.sbt.web.common.interceptor.dao;

import com.kubrick.sbt.web.common.annotation.datascope.DataPermission;
import com.kubrick.sbt.web.common.auth.CustomerUserDetails;
import com.kubrick.sbt.web.common.datascope.*;
import com.kubrick.sbt.web.domain.entity.User;
import com.kubrick.sbt.web.common.auth.utils.SecurityUtils;
...
public class DataScopeInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (SQL_SELECT_FIELD.equals(sqlCommandType)) {
			...
			CustomerUserDetails currentUser = SecurityUtils.getCurrentUser();
			List<Long> ogs = null;
			// 默认 2 本人权限
			Integer dsType = 2;
			if (currentUser != null) {
