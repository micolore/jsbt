...
ALTER TABLE `t_menu`
    DISABLE KEYS;
INSERT INTO `t_menu` (`id`, `menu_name`, `menu_url`, `menu_code`, `parent_id`, `menu_type`, `order_num`, `creator`,
                      `create_time`, `updator`, `update_time`, `deleted`)
VALUES (1, '公共资源', '/publicResource', NULL, 0, 0, 99, NULL, NULL, NULL, NULL, 0),
...
ALTER TABLE `t_organization`
    DISABLE KEYS;
INSERT INTO `t_organization` (`id`, `name`, `pid`, `deep`, `status`, `create_at`, `create_by`)
VALUES (1, 'google', 0, 0, 1, NULL, 1),
...
ALTER TABLE `t_role`
    DISABLE KEYS;
INSERT INTO `t_role` (`id`, `role_name`, `data_scope`, `create_at`, `create_by`)
VALUES (1, 'ROLE_USER', 2, NULL, 0),
...
ALTER TABLE `t_user`
    DISABLE KEYS;
INSERT INTO `t_user` (`id`, `username`, `password`, `organization`, `status`, `create_by`, `create_at`)
VALUES (1, 'user', '$2a$10$D5E9lza7z8uea6fP/oNOJeuRq/a/y8RXQWslTDONsqxQTPlgW7Hr6', 0, 0, 1, NULL),
