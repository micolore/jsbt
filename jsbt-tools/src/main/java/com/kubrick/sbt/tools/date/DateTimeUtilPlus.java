package com.kubrick.sbt.tools.date;
...
public class DateTimeUtilPlus {
	...
	public static LocalDateTime randomLocalDateTimeBefore() {
		...
		localDateTime = randomLocalDateTime(formatLocalDateTime(DateTimeUtils.get()),
				formatLocalDateTime(DateTimeUtils.get()));
		if (localDateTime.isBefore(DateTimeUtils.get())) {
			return localDateTime;
		}
		else {
