...
/**
 * @author k
 * @version 1.0.0 @ClassName ElasticsearchTest
 * @description: TODO
...
public class ElasticsearchTest {
  ...
  @Test
  public void testScrmExistIndex() throws IOException {
    GetIndexRequest request = new GetIndexRequest("wscrm_message_new");
    boolean exists = restHighLevelClient.indices().exists(request, RequestOptions.DEFAULT);
    System.out.println(exists);
  }
}
